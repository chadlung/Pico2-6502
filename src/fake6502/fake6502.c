 ...
 *
 * Pico 6502 changes: reset6502() sets the I flag as an NMOS 6502 does, and
 * fake6502.h no longer declares the nonexistent 'status' variable.
 * Taken from https://github.com/ivop/fake6502 commit b52676f.
 */
